...
class FCN_SS(object):
    ...
    def build_train_graph(self):
        ...
        with tf.name_scope("Training"):
            ...
            lr = tf.train.exponential_decay(opt.learning_rate, global_step, (self.total_steps / 2), Decay,
                                            staircase=True)
    ...
    def Create_batches(self, train_data, train_label):
        ...
        train_label_batch = np.zeros((self.batch_size, self.img_height * self.img_width, self.N_classes),
                                     dtype=np.float32)
    ...
    def train(self, opt):
        ...
        with sv.managed_session() as sess:
            ...
            for step in range(1, opt.max_steps):
                ...
                fetches = {"Training": self.Training, "global_step": self.global_step,
                ...
                # print(train_label_batch.shape)
                results = sess.run(fetches, feed_dict={self.train_image_batch: train_image_batch,
                                                       self.train_label_batch: train_label_batch})
    ...
    def build_test_graph(self):
        input_img = tf.placeholder(tf.float32, [self.batch_size, self.img_height, self.img_width, 3],
                                   name='input_image')
